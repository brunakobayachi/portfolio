...
const resources = {
    en: {
        translation: {
            ...
            work_desc1: 'Started to study Energy Engineering, ends at 2023.',
            ...
            work_name4:'Fullstack Developer',
            work_desc4:'I work as a fullstack developer on a project focused on creation and marketing of digital courses and classes. At frontend I create layouts and make integrations with the backend, using React, Next and axios. At backend I create, refactor routes and database models to be consumed at the frontend, using NodeJS, Express and Prisma ORM.',
    ...
    pt_BR: {
        translation: {
            ...
            work_desc1: 'Começou a estudar Engenharia de Energia, previsão para formação em 2023.',
            ...
            work_desc4:'Atuo como desenvolvedora fullstack, onde no frontend crio layouts e faço integrações com o backend, usando React, Next e axios. E no backend crio, refatoro rotas e modelos no banco de dados para serem consumidas pelo frontend, usando NodeJS, Express e Prisma ORM. Lido com a parte de deploys, feita com AWS e Vercel.',
            // work_desc4:'Atuo como desenvolvedora fullstack, onde no frontend crio layouts e faço integrações com o backend, usando React, Next e axios. E no backend crio, refatoro rotas e modelos no banco de dados para serem consumidas pelo frontend, usando NodeJS, Express e Prisma ORM.',
